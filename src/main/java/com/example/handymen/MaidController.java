...
public class MaidController {
    ...
    @FXML
    private TableView<Worker> maidTable;
    ...
    private ObservableList<Worker> maidList = FXCollections.observableArrayList();
