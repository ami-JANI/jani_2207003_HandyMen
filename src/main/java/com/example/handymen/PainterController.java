...
public class PainterController {
    ...
    @FXML
    private TableView<Worker> painterTable;
    ...
    private ObservableList<Worker> painterList = FXCollections.observableArrayList();
    ...
    private void loadPainterWorkers() {
        ...
        try (Connection conn = DatabaseConnection.connect()) {
            ...
            painterTable.setItems(painterList);
